...
const faqs = [
  ...
  {
    question: "5. Is PicLumen's text to image AI free to use?",
    answer: "Yes, it’s free to use with some limitations depending on the plan.",
  },
  {
    question: "6. Is PicLumen's text-to-image generator easy for beginners?",
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <div
                className={`overflow-hidden transition-all duration-500 ease-in-out px-4 pb-4 ${
                  openIndex === index
